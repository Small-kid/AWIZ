...
struct ContentView: View {
    @State var exercisePlans = [
        ...
        ExercisePlan(title: "Exercise Plan 2", details: "Choose this for a medium difficulty workout",
                     ...
                     exercise3: Exercise(title: "Jog on the spot", duration: 5, steps: "", video: AVPlayer(url:  Bundle.main.url(forResource: "JogOnTheSpot" , withExtension: "MOV")!)),
        ...
        ExercisePlan(title: "Exercise Plan 3", details: "Choose this plan for a more intermediate set of workouts",
                     exercise: Exercise(title: "Tricep Stretch", duration: 5, steps: "", video: AVPlayer(url:  Bundle.main.url(forResource: "TricepStretch" , withExtension: "MOV")!)),
                     exercise2: Exercise(title: "Toe Touches", duration: 5, steps: "", video: AVPlayer(url:  Bundle.main.url(forResource: "ToeTouches" , withExtension: "MOV")!)),
                     exercise3: Exercise(title: "Leg Raises", duration: 5, steps: ""),
                     exercise4: Exercise(title: "Wall Push Ups", duration: 5, steps: "", video: AVPlayer(url:  Bundle.main.url(forResource: "WallPushUp" , withExtension: "MOV")!)),
                     exercise5: Exercise(title: "Jog on the Spot", duration: 10, steps: "", video: AVPlayer(url:  Bundle.main.url(forResource: "JogOnTheSpot" , withExtension: "MOV")!))),
