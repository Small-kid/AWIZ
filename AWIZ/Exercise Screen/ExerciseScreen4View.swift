...
struct ExerciseScreen4View: View {
    ...
    var body: some View {
        VStack {
            ...
            NavigationLink(destination: ExerciseScreen5View( exercisePlan: exercisePlan))
            {
                Text("Next exercise")
                    .padding()
...
struct ExerciseScreen4View_Previews: PreviewProvider {
    static var previews: some View {
        ExerciseScreen4View(exercisePlan: ExercisePlan(title: "Exercise Plan 1", details: "Choose this plan for a more basic workout",
