...
struct ExerciseScreen3View: View {
    ...
    var body: some View {
        VStack {
            ...
            NavigationLink(destination: ExerciseScreen4View( exercisePlan: exercisePlan))
            {
                Text("Next exercise")
                    .padding()
...
struct ExerciseScreen3View_Previews: PreviewProvider {
    static var previews: some View {
        ExerciseScreen3View(exercisePlan: ExercisePlan(title: "Exercise Plan 1", details: "Choose this plan for a more basic workout",
