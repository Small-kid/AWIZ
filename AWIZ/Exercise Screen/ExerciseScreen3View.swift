...
struct ExerciseScreen3View: View {
    ...
    var body: some View {
        VStack {
            ...
            Form {
                Section(header: Text("3rd Exercise (Scroll down for exercise steps)")) {
                ...
                Section(header: Text("Video example")) {
                    VideoPlayer(player: exercisePlan.exercise3.video)
                        .scaledToFit()
                ...
                Section(header: Text("Steps:")){
                    Text(exercisePlan.exercise3.steps)
...
struct ExerciseScreen3View_Previews: PreviewProvider {
    static var previews: some View {
        ExerciseScreen3View(streaks: .constant(Streaks()), timerStruct: .constant(TimerStruct()), exercisePlan: ExercisePlan(title: "Exercise Plan 1", details: "Choose this plan for a more basic workout",
