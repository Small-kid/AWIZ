...
struct ExerciseScreen2View: View {
    ...
    var body: some View {
        VStack {
            Form {
                Section(header: Text("2nd Exercise (Scroll down for exercise steps)")) {
...
struct ExerciseScreen2View_Previews: PreviewProvider {
    static var previews: some View {
        ExerciseScreen2View(streaks: .constant(Streaks()), timerStruct: .constant(TimerStruct()), exercisePlan: ExercisePlan(title: "Exercise Plan 1", details: "Choose this plan for a more basic workout",
